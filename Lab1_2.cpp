...
const string KEYWORDS[] = {"break","case","char","const","continue","default","do","double","else","extern","float","for","if"
,"int","long","register","return","short","signed","sizeof","static","struct","switch","unsigned","void","while"};

const int KEYWORDS_LIST_NUM = 26;
...
void CountSwitchAndCases() {
	...
	for (int i = 0; i < keywords_count; i++)
		if (keywordsShown[i].compare(target_switch) == 0 ||(keywordsShown[i].compare(target_switch) != 0 
...
void CountIfElseNum() {
	const string keywordsAndBraces[] = 
	{"break","case","char","const","continue","default","do","double","else","extern","float","for","if"
          ,"int","long","register","return","short","signed","sizeof","static","struct","switch","unsigned","void","while","{","}" };
